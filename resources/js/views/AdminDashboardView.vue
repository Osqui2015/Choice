        ...
        <div v-else-if="stats" class="space-y-6">
            ...
            <div class="grid sm:grid-cols-3 gap-3">
                <div class="bg-slate-800 border border-slate-700 rounded-xl p-4">
                    ...
                    <p class="mt-1 text-2xl font-bold text-white">{{ stats.activity.answers_total }}</p>
                </div>
                <div class="bg-slate-800 border border-slate-700 rounded-xl p-4">
            ...
            <div class="bg-slate-800 border border-slate-700 rounded-2xl p-5">
                <h2 class="text-lg font-bold text-white mb-3">🏆 Top 5 usuarios por respuestas correctas</h2>
                <div class="space-y-2">
            ...
            <!-- Por especialidad -->
            <div class="bg-slate-800 border border-slate-700 rounded-2xl p-5">
                <h2 class="text-lg font-bold text-white mb-3">📚 Por Especialidad</h2>
                <div class="space-y-3">
                    <div v-for="s in stats.by_specialty" :key="s.id" class="flex items-center justify-between p-3 rounded-lg bg-slate-900/50">
                        <div>
                            <p class="text-sm font-semibold text-white">{{ s.name }} <span class="text-slate-500 text-xs">({{ s.code }})</span></p>
